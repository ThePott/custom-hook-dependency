  ...
  return (
    <>
      ...
      <div className="container">
        ...
        <button onClick={() => dogFetchData()}>new Dog</button>
        {dogLoading ? (
      ...
      <div className="container">
        ...
        <button onClick={() => catFetchData()}>new Cat</button>
        {catLoading ? (
          <p className="loading">Loading . . .</p>
        ) : (
          catData && (
